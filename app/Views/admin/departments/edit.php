...
<div class="card shadow-sm border-0">
    <div class="card-body p-4">
        <form action="<?= URLROOT ?>/admin/departments/update/<?= $department->id ?>" method="POST">
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="icon" name="icon" value="<?= $department->icon ?>" placeholder="เช่น bi-hospital">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" id="status" name="status">
                        <option value="active" <?= $department->status == 'active' ? 'selected' : '' ?>>เปิดใช้งาน</option>
                        <option value="inactive" <?= $department->status == 'inactive' ? 'selected' : '' ?>>ปิดใช้งาน</option>
                    </select>
                </div>
            </div>
